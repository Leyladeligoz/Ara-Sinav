...
# y =int(input("En fazla iki basamaklı olacak şekilde sayı giriniz."))
...
#         a = sayı%10
#         if (l + a) % 2 == 0:
#          print(sayı, "=", l + a,"Sayı çifttir. Dosyaya yazılamaz.")
#         else:
#          print(sayı, "=", l + a, "Sayı tektir. Dosyaya yazılabilir.")
#          f.write(str(sayı))
